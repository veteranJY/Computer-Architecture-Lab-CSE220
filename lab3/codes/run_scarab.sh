...
do
	...
	echo "(cd $executing_location && exec $input_excutable --frontend memtrace --cbp_trace_r0=$trace_location --memtrace_modules_log=$module_location $3 $4)"
	(cd $executing_location && exec $input_excutable --frontend memtrace --cbp_trace_r0=$trace_location --memtrace_modules_log=$module_location $3 $4)
